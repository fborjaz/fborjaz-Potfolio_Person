...
const Navbar = ( ) => {
  ...
  return (
    <nav className="relative z-10 rounded-b-lg shadow-md mb-20 px-4 py-6 flex items-center justify-between max-w-screen-xl mx-auto bg-gray-900">
      ...
      <div className="flex items-center gap-4">
        <a href="#" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
          <FaLinkedin className="fill-current w-4 h-4" />
        </a>
        <a href="#" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
          <FaGithub className="fill-current w-4 h-4" />
        </a>
        <a href="#" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
          <FaSquareXTwitter className="fill-current w-4 h-4" />
        </a>
        <a href="#" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
          <FaInstagram className="fill-current w-4 h-4" />
        </a>
      </div>
    </nav>
  );
